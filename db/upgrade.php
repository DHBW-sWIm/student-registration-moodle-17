...
function xmldb_local_student_registration_upgrade($oldversion) {
    ...
    if ($oldversion < 2020051801) {
        ...
        if ($oldversion < 20200625014) {
            ...
            $DB->insert_record('sr_management_tiles' , array('title'=>'Student Registration' , 'button_name' => 'Manage' , 
            ...
            //
            $DB->insert_record('sr_management_tiles' , array('title'=>'Scientific Paper' , 'button_name' => 'Manage' , 
            ...
            //
            $DB->insert_record('sr_management_tiles' , array('title'=>'Dashboard Settings' , 'button_name' => 'Settings' , 
            ...
            //
            $DB->insert_record('sr_management_tiles' , array('title'=>'Capacity Planning' , 'button_name' => 'Manage' , 
            ...
            //
            $DB->insert_record('sr_management_tiles' , array('title'=>'Course Management' , 'button_name' => 'Manage' , 
            ...
            $DB->insert_record('sr_management_tiles' , array('title'=>'Settings for STRE' , 'button_name' => 'Edit' , 
            ...
            'plugin'=>'Student Registration' , 'task_path' =>''));
            //
            $DB->insert_record('sr_management_tiles' , array('title'=>'Lecturer recruitment' , 'button_name' => 'Manage' , 
            'button_url'=>'/local/student_registration/index.php' , 'button_icon'=>'fa fa-user','list_element_1'=>'Help center access', 
            'list_element_2'=>'','list_element_3'=>'','list_element_4'=>'','color'=>'danger','tile_order'=> 3 , 
            'plugin'=>'Management Dashboard' , 'task_path' =>''));
            //
            $DB->insert_record('sr_management_tiles' , array('title'=>'CRM' , 'button_name' => 'Go to V-Tiger' , 
            ...
            $DB->insert_record('sr_management_tiles' , array('title'=>'Study Programs Managemet' , 'button_name' => 'Manage' , 
