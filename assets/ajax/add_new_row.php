...
if($free > 0){
  $reserved++;
  $id = $DB->insert_record("sr_reservation_list", array('first_name'=>'Reserved','last_name'=>'Study Place','contract_status'=>'Not Signed' ,'sr_company_representative_id'=>$user, 'sr_process_id'=>$processID , 'sr_study_fields_id' =>$DSRow[$DSRecordID]->sr_study_fields_id));
