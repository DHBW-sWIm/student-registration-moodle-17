  <?php
    ...
    function notify_cr_pu($from = '', $demandStart, $startA, $startB, $processEnd, $studyProgram)
    {
        global $DB;
        if (empty($from)) {
            $from = 'DHBW Mannheim';
        ...
        $title = 'Student Registration Process Update';
        foreach ($users as $cr) {
            ...
            $form .= '<br>The DHBW Mannheim updated the student reservation process for the study program: <b>' . $studyProgram . ' </b>.';
