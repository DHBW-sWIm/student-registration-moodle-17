  ...
  function notify_cr_wl_to_rl($from = '', $PID, $SFID, $CRID)
  {
    global $DB;
    if (empty($from)) {
      $from = 'DHBW Mannheim';
    ...
    $form .= '<br>We confirm here by that we moved one of your records on the Waiting List to Reservation List of the program: ' . $ProName . ' ' . $FieldName . '<br>';
