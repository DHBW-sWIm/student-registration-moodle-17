  ...
  var methods = {
    init: function (options) {
      ...
      if (!notNull(options.columns)) {
        ...
        console.log(
          "Tabledit Jquery Plugin not initialize. Set required parameters."
        );
        return this;
      }
      ...
      $(this).data(
        dataPrefix,
        $.extend({}, $table.Tabledit.defaults, options || {})
      );
      ...
      if (settings.confirmButton && settings.buttons.confirm.html) {
        ...
        var confirmButtonHtml =
          $table.Tabledit.langs[settings.lang].btn_confirm;
      }
      ...
      function handleAjaxError(jqXHR, textStatus, errorThrown) {
        ...
        var statusErrorMap = {
          ...
          "400":
            "Server understood the request, but request content was invalid [400].",
        ...
        if (jqXHR.status) {
          ...
          msg =
            "Ajax Error!! Parsing JSON Request failed. \n" +
            "Detail =>" +
            textStatus +
            " : " +
            errorThrown;
      ...
      function ajax(action) {
        ...
        jqXHR.fail(function (jqXHR, textStatus, errorThrown) {
          ...
          // Output to console with data
          if (options.debug)
            console.log(handleAjaxError(jqXHR, textStatus, errorThrown));
        });
        ...
        columns: {
          identifier: function () {
            ...
            $td.each(function () {
              ...
              $(this)
                .parent("tr")
                .attr(settings.rowIdentifier, $.trim($(this).text()));
            });
          },
          editable: function () {
            for (var i = 0; i < settings.columns.editable.length; i++) {
              var $td = $table
                ...
                .filter(
                  ":nth-child(" +
                    (parseInt(settings.columns.editable[i][0]) + 1) +
                    ")"
                );
              ...
              $td.each(function () {
                ...
                switch (columnType) {
                  ...
                  case "select":
                    ...
                    if (
                      typeof settings.columns.editable[i][3] !== "undefined"
                    ) {
                      ...
                      $.each(
                        $.parseJSON(settings.columns.editable[i][3]),
                  ...
                  case "textarea":
                    ...
                    if (
                      ...
                      $.each(
                        ...
                        function (index, value) {
                          ...
                          input +=
                            $.inArray(index, supportedAttrTextarea) != -1
                              ? index + '="' + value + '" '
                              : "";
                          ...
                          if (index == "maxlength" && value.length > 0) {
                            counttext =
                              $table.Tabledit.langs[
                                settings.lang
                              ].txt_allowchar.replace("%s", value) +
                              ' | <span class="countno_"></span> ' +
                              $table.Tabledit.langs[settings.lang].txt_remain;
                          } else {
                            counttext =
                              $table.Tabledit.langs[settings.lang].txt_nolimit;
                          }
                        }
                      );
                    } else {
                    ...
                    input +=
                      ...
                      '" style="display: none;" disabled>' +
                      text +
                      '</textarea><span class="count_" style="display: none;">' +
                      counttext +
                      "</span>";
            ...
            if (settings.editButton || settings.deleteButton) {
                ...
                $table
                  ...
                  .append(
                    '<th class="tabledit-toolbar-column ' +
                      settings.toolbarHeaderClass +
                      '">' +
                      $table.Tabledit.langs[settings.lang].txt_action +
                      "</th>"
                  );
              }
              ...
              if (settings.deleteButton) {
                ...
                confirmButton =
                  ...
                  '" style="display: none; float: none; margin-left: 10px;">' +
                  confirmButtonHtml +
                  "</button>";
              }
              ...
              var toolbar =
                ...
                '" style="text-align: left;flex-wrap: nowrap;">\n\
                                             <div class="' +
                settings.groupClass +
                '" style="float: none;">' +
                editButton +
              ...
              $table
                .find('tbody > tr:not(".' + settings.noEditClass + '")')
                .append(
              ...
              $table
                .find("tbody > tr." + settings.noEditClass)
                .append(
                  '<td class="toolbar" style="white-space: nowrap; width: 1%;"></td>'
                );
            }
          },
        },
      ...
      var Mode = {
        ...
        edit: function (td) {
          ...
          $(td)
            .find(".count_")
            .css({ color: "#CCC", display: "block", float: "right" })
            .show();
        ...
        submit: function (td) {
          ...
          $(td).each(function () {
            ...
            if ($input.is("select")) {
              $(this)
                .find(".tabledit-span")
                .text($.trim($input.find("option:selected").text()));
            } else {
      ...
      var Delete = {
        ...
        submit: function (td) {
          ...
          // Hide table row.
          $(td).parent("tr").fadeOut(); //addClass(settings.mutedClass).find('.tabledit-toolbar button:not(.tabledit-restore-button)').attr('disabled', true);
          // Show restore button.
          $(td).find(".tabledit-restore-button").show();
          // Set last deleted row.
          $lastDeletedRow = $(td).parent("tr");

          if ($("#counterSP").length > 0) {
    ...
    update: function (options) {
      ...
      if (!defaults) {
        console.log(
          "Tabledit Update -> Data: EditTable must be initialized before setting options"
        );
        return;
      }
