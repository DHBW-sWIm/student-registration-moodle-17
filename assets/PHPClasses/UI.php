...
class CreateTile {
    ...
    function __construct($record, $context) {
        ...
        $this->setTaskListItem($record->task_path , $record->function ,$record->list_element_1);
        $this->setTaskListItem($record->task_path, $record->function  ,$record->list_element_2);
        $this->setTaskListItem($record->task_path , $record->function ,$record->list_element_3);
        $this->setTaskListItem($record->task_path , $record->function ,$record->list_element_4);
    ...
    public function setTaskListItem($link = ' ', $function = ' ' ,$taskName = ' '){
