...
if (has_capability('local/student_registration:manage', $context)) {
    ...
    $SPname = $DB->get_record_select('sr_process', 'id = ?', array($processID));
    echo $OUTPUT->heading('Study Fields Reporting for ' . $SPname->program_name);
    echo '</br>';
    ...
    $(function() {
        $('#my-table tr[RecordID] td').each(function() {
            $(this).css('cursor', 'pointer').hover(
                ...
                redirectUrl = 'ST_company_reporting.php';
