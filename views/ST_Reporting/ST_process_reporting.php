...
if (has_capability('local/student_registration:manage', $context)) {
    ...
    echo '</br>';
    echo '<input type="button" id="view_all" class="btn-danger pull-right" value="Integrated Report">';
    echo '</br>';
...
<script>
    ...
    //redirect to integrated report
    $(document).ready(function() {
        $('#view_all').click(function() {
            var ProcessID = $('#ProcessID').html();
            var redirectUrl = 'ST_course_fill_rate.php';
            var form = $('<form action="' + redirectUrl + '" method="post">' +
