...
if (has_capability('local/student_registration:cr', $context)) {
    ...
    if ($records) {
        ...
        foreach ($records as $record) {
            ...
            if (isset($record->current_demand)) {
            ...
            if ($record->study_places_available != 0) {
                if ($available > 0) {
                    ...
                    $padg2 = '<b><span class="badge badge-pill badge-danger">No Seats left</span></b>';
                    $cell1->text = '<h5><b><span class="badge badge-pill badge-warning">Wating list Possible</span></b></h5>';
                }
            } else {
                $padg2 = '<b><span class="badge badge-pill badge-danger">No Seats availabe</span></b>';
