...
if (has_capability('local/student_registration:cr', $context)) {
    ...
    if ($classification === 'A') {
        ...
        $startDate = 'start_date_for_b';
    } else {
        die('<div id="errormsg" class="alert alert-danger alert-dismissible fade show" role="alert">User is not a Company Representative or Partner Company is Classified neither A nor B!!!!<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
    }
