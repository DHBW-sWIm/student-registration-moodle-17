...
<script>
  function checkHTMLForm() {
    ...
    if (dateProcessEnd == "" || dateDemandStart == "" || dateRegStartA == "" || dateRegStartB == ""){
      event.preventDefault();
      event.stopPropagation();
      $("#notification").append('<div id="errormsg" class="alert alert-danger alert-dismissible fade show" role="alert">No input in every date field<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
      $(".alert").delay(4000).slideUp(200, function() {
        $(this).alert('close');
      });
    }
      ...
      event.preventDefault();
      event.stopPropagation();
      $("#notification").append('<div id="errormsg" class="alert alert-danger alert-dismissible fade show" role="alert">Check the input field Demand planning start date for valid input.<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
      $(".alert").delay(4000).slideUp(200, function() {
        $(this).alert('close');
      });
        ...
        event.preventDefault();
        event.stopPropagation();
        $("#notification").append('<div id="errormsg" class="alert alert-danger alert-dismissible fade show" role="alert">Check the input field Start date for student registration parter A for valid input.<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
        $(".alert").delay(4000).slideUp(200, function() {
          $(this).alert('close');
        });
        ...
        event.preventDefault();
        event.stopPropagation();
        $("#notification").append('<div id="errormsg" class="alert alert-danger alert-dismissible fade show" role="alert">Check the input field Start date for student registration partner B for valid input.<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
        $(".alert").delay(4000).slideUp(200, function() {
          $(this).alert('close');
        });
      }
