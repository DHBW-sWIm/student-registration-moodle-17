...
if(has_capability('local/student_registration:manage', $context)){
    ...
    $PAGE->requires->jquery();
        ...
        $name = current($name);
        echo $OUTPUT->heading('Waiting List Management for '.$name->program_name);
        /*
        ...
        */
        ...
        $table->head = array('Study Field', 'Total Capacity' , 'Reserved Seats' , 'Total records on Waiting list');
        $table->align = array('left', 'left','left');
            ...
            foreach($records as $record) {
               ...
               if($record->current_demand){
               }else $record->current_demand =0;
               $cell3->text =$record->current_demand;
