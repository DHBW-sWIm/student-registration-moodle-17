...
if(has_capability('local/student_registration:manage', $context)){
        ...
        */
        ...
        ($waitingliststatus->manual_waiting_list == '0') ? $waitingliststatus = 'off' : $waitingliststatus = 'on';
        echo $OUTPUT->footer();
...
$(function(){
    ...
    $('#my-table thead tr').append('<td class="pull-right"><b>Manual Waiting List</b></td>');
    
        i = 0;
    $('#my-table tr[RecordID]').each(function(){
        i++;
        $(this).append('<td id="waitinglist'+i+'" style="cursor: pointer;"><button type="button" class="btn btn-default pull-right" style="cursor: pointer;">Waiting List</button></td>');
