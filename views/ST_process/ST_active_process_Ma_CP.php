...
if(has_capability('local/student_registration:manage', $context)){
    ...
    $PAGE->navbar->add('Management Dashboard',new moodle_url('/local/student_registration/views/Menu.php'));
        ...
        */
        ...
        $records = $DB->get_records_select("sr_process",'closed=0' ,array('*') );
            ...
            for($i=0; $i<$count; $i++) {
               ...
               $row->attributes['data-href'] = 'ST_capacity_planning.php?#RecordID='.$records[$i+1]->id.'';
