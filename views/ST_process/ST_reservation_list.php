    ...
    jQuery("#addRow9").on('click', function() {
      ...
      jQuery.ajax({
        ...
        success: function(data) {
          ...
          jQuery("#notification").html('<div id="statusnotification" class="alert alert-success alert-dismissible fade show" role="alert">A new placeholder was registered successfully<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
