                ...
                if (window.confirm("Are you sure?")) {
                    $.ajax({
                        ...
                        success: function(data) {
                            $("#notification").html('<div id="errormsg" class="alert alert-success alert-dismissible fade show" role="alert">Record has been deleted from Reservation List<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
